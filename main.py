...
pygame.init()
engine = chess.engine.SimpleEngine.popen_uci("Assests/Pretrained AI/stockfish-windows-x86-64-avx2.exe")
board = chess.Board()
...
white_pawn   = load_and_scale("Assests/Pieces/Book Diagram/wp.svg")
white_bishop = load_and_scale("Assests/Pieces/Book Diagram/wb.svg")
white_king   = load_and_scale("Assests/Pieces/Book Diagram/wk.svg")
white_horse  = load_and_scale("Assests/Pieces/Book Diagram/wn.svg")
white_queen  = load_and_scale("Assests/Pieces/Book Diagram/wq.svg")
white_rook   = load_and_scale("Assests/Pieces/Book Diagram/wr.svg")

black_pawn   = load_and_scale("Assests/Pieces/Book Diagram/bp.svg")
black_bishop = load_and_scale("Assests/Pieces/Book Diagram/bb.svg")
black_king   = load_and_scale("Assests/Pieces/Book Diagram/bk.svg")
black_horse  = load_and_scale("Assests/Pieces/Book Diagram/bn.svg")
black_queen  = load_and_scale("Assests/Pieces/Book Diagram/bq.svg")
black_rook   = load_and_scale("Assests/Pieces/Book Diagram/br.svg")
